...
register_env_with_variants(id='myoStandingBack-v0',
        ...
        kwargs={
            ...
            'target_jnt_range': {'Abs_t1':(0, 0),'Abs_t2':(0,0),'Abs_r3':(0, 0),
...
register_env_with_variants(id='myoStandingBackExo-v1',
        entry_point='myosuite.envs.myo.myobase.back_v1:BackEnvV0',
        max_episode_steps=300,
        kwargs={
            'model_path': curr_dir+'/../../../simhive/myo_sim/torso/myotorso_exosuite.xml',
            'target_jnt_range': {'Abs_t1':(0, 0),'Abs_t2':(0,0),'Abs_r3':(0, 0),
